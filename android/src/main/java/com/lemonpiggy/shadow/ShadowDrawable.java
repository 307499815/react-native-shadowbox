...
public class ShadowDrawable extends Drawable {
	...
	private ShadowDrawable(int shape, int[] bgColor, float shapeRadius, int shadowColor, float shadowRadius, float offsetX, float offsetY) {
		this.mShape = shape;
	 ...
	 */
	public static void setShadowDrawable(View view, float shapeRadius, int shadowColor, float shadowRadius, float offsetX, float offsetY) {
	 ...
	 * @param offsetY 阴影垂直方向的偏移量
	 */
	public static void setShadowDrawable(View view, int bgColor, float shapeRadius, int shadowColor, float shadowRadius, float offsetX, float offsetY) {
		ShadowDrawable drawable = new ShadowDrawable.Builder()
				.setBgColor(bgColor)
				.setShapeRadius(shapeRadius)
				.setShadowColor(shadowColor)
	 ...
	 * @param offsetY 阴影垂直方向的偏移量
	 */
	public static void setShadowDrawable(View view, int shape, int bgColor, float shapeRadius, int shadowColor, float shadowRadius, float offsetX, float offsetY) {
		ShadowDrawable drawable = new ShadowDrawable.Builder()
				.setShape(shape)
				.setBgColor(bgColor)
				.setShapeRadius(shapeRadius)
	...
	public static class Builder {
		...
		public Builder setShapeRadius(float ShapeRadius) {
			this.mShapeRadius = ShapeRadius;
			return this;
		}
